    ...
    <>
      ...
      >
        <section className="max-w-7xl w-full h-full flex flex-col gap-8">
          ...
          <article className="flex flex-col lg:flex-row-reverse overflow-x-auto items-center justify-center lg:justify-between gap-4 bg-gradient-to-r from-[#16181d] to-[#646674]/25 md:rounded-md overflow-hidden p-2 md:p-4">
